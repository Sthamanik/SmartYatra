...
const LoginScreen = () => {
  ...
  // Password Validation Regex (Min 6 characters, at least 1 number, 1 letter)
          ...
          <View className="flex-1 px-5 py-10">
            ...
            <View className="mb-6">
              ...
              <TouchableOpacity
                ...
                onPress={handleLogin}
                disabled={!email || !password || errors.email || errors.password ? true : false} // ✅ Ensuring boolean value
              >
